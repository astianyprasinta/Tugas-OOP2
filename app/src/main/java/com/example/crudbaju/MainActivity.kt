...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listUsr.setOnItemClickListener{ parent, view, position, id ->
            ...
            val intent = Intent(this@MainActivity, AddModelBajuActivity::class.java)
            intent.putExtra(AddModelBajuActivity.EXTRA_ID, user.id)
            intent.putExtra(AddModelBajuActivity.EXTRA_NAMA, user.nama)
